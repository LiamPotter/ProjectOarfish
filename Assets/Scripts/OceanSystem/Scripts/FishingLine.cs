...
public class FishingLine : MonoBehaviour
{
    ...
    // ─────────────────────────────────────────────────────────────────────────
    [Header("End Points")]
    [Tooltip("The tip of the fishing rod — where the line begins.")]
    ...
    [Range(0.5f, 50f)] public float lineRestLength = 10f;
    ...
    [Range(0f, 10f)] public float maxSlackDrop = 1.5f;
    ...
    [Range(0f, 0.9f)] public float fullSlackFraction = 0.3f;

    [Tooltip("Number of segments used to draw the catenary curve. " +
             "Higher = smoother curve but more vertices.")]
    [Range(4, 64)] public int segmentCount = 24;

    [Tooltip("How quickly the slack value transitions as the lure moves. " +
             "Higher = snappier tension response.")]
    [Range(0.5f, 20f)] public float tensionSpeed = 6f;

    // ─────────────────────────────────────────────────────────────────────────
    // Inspector – Line Renderer appearance
    // ─────────────────────────────────────────────────────────────────────────
    [Header("Line Renderer")]
    [Tooltip("Width of the line at the rod tip.")]
    [Range(0.001f, 0.05f)] public float lineWidthStart = 0.008f;

    [Tooltip("Width of the line at the lure.")]
    [Range(0.001f, 0.05f)] public float lineWidthEnd = 0.004f;
    ...
    [Tooltip("Maximum vertical amplitude of the bob animation (metres).")]
    [Range(0f, 0.5f)] public float bobAmplitude = 0.06f;

    [Tooltip("Frequency of the bob animation (cycles per second).")]
    [Range(0.1f, 5f)] public float bobFrequency = 0.8f;
    ...
    [Range(0f, 1f)] public float tautnessOverride = 0f;

    // ─────────────────────────────────────────────────────────────────────────
    // Inspector – Debug
    // ─────────────────────────────────────────────────────────────────────────
    [Header("Debug")]
    [Tooltip("Draw the chord and sag midpoint in the Scene view.")]
